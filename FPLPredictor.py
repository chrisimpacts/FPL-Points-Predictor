...
# from sklearn.model_selection import train_test_split, GridSearchCV
# from sklearn.ensemble import RandomForestRegressor
# from sklearn.metrics import mehan_squared_error, r2_score, mean_absolute_error
# import matplotlib.pyplot as plt
# from typing import List, Set, Tuple, Optional, Dict, Any
...
#     # Example with optimization and NaN filtering
#     print("\n" + "=" * 80)
...
#     best_params_grid = FWD_xG_predictor.get_best_params_as_grid()
    
#     # Analyze largest errors
#     largest_errors = FWD_xG_predictor.get_largest_errors(n=10, dataset='test')
    
#     # Full error analysis with visualizations
#     error_stats = FWD_xG_predictor.analyze_errors(dataset='test')
    
#     # Get full data for largest errors (includes all original columns)
#     largest_errors_full = FWD_xG_predictor.get_largest_errors(
#         n=10, 
#         dataset='test', 
...
#     print("\n" + "=" * 80)
#     print("MID xG Predictor with GridSearch Optimization")
#     print("=" * 80)
...
#         optimize=True,
#         cv_folds=5,
#         max_nan_pct=5  # Stricter filtering for MID
#     )
#     MID_xG_predictor.fit()
#     MID_xG_predictor.plot_results()
    
#     # Analyze errors for MID
#     MID_xG_predictor.get_largest_errors(n=10)
    
#     # Example without optimization (original behavior)
#     print("\n" + "=" * 80)
#     print("DEF xG Predictor (No Optimization)")
#     print("=" * 80)
...
#         positions={'DEF'},
#         columns_to_drop=cbi_defcon_cols,
#         optimize=False  # Use default parameters
#     )
#     DEF_xG_predictor.fit()
#     DEF_xG_predictor.plot_results()
#     DEF_xG_predictor.analyze_errors()